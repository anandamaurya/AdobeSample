//
//  ABDSideMenuTableViewController.swift
//  ADBMobileSamples
//
//  Created by Rohit Sisodia on 31/08/19.
//  Copyright © 2019 Adobe. All rights reserved.
//

import UIKit

class ABDSideMenuTableViewController: UITableViewController {

    let headingArray = ["", "Last Bill Amount",
                        "Current Uses",
                        "Current Plan"]
    let descriptionArray = ["200 AUD",
                            "100",
                            "Plan 1",
...
//        tableView.register(ADBSideTableViewCell.self, forCellReuseIdentifier: "ADBSideTableViewCell")
