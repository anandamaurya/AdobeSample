...
public class LFLoginController: UIViewController {
    ...
    convenience init() {
        ...
        print("layout")
        //view.backgroundColor = UIColor(red: 128 / 255, green: 191 / 255, blue: 102 / 255, alpha: 1)
    ...
    func setupLoginLogo() {
        ...
        //if let loginLogo = logo {
            ...
            imgvLogo.image = UIImage.init(imageLiteralResourceName: "caplogo-removebg-preview")
